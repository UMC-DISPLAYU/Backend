...
public record CreatePersonalArtworkFeelingRequest(
    @NotBlank(message = "감상평 내용은 필수입니다.") @Size(min = 1, max = 300, message = "감상평은 1자 이상 300자 이하로 입력해주세요.") String content,
    @Size(max = 5, message = "사진은 최대 5개까지 첨부할 수 있습니다.") List<@NotNull @Valid PersonalArtworkFeelingImageRequest> images) {

  public record PersonalArtworkFeelingImageRequest(
