...
public record ArchiveWorkResult(
  ...
  // 개인 작품에는 메모 기능이 아직 없고, 요약 정보(PersonalArtworkSummaryResult)에 작가명이 없어 memo/artistName은 항상 null이다.
  public static ArchiveWorkResult fromPersonal(
      ArchivePersonalWork archivePersonalWork, PersonalArtworkSummaryResult summary) {
    return new ArchiveWorkResult(
