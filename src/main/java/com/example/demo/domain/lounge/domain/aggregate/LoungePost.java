...
public class LoungePost extends SoftDeleteBaseEntity {
    ...
    public static LoungePost create(UserId authorUserId, String title, String content, LoungePostCategory category) {
        return create(authorUserId, title, null, content, category);
    }

    public static LoungePost create(UserId authorUserId, String title, String postImageUrl, String content, LoungePostCategory category) {
        return new LoungePost(null, authorUserId, title, postImageUrl, content, category, LoungePostStatus.ACTIVE);
    }

    public LoungePost(Long id, UserId authorUserId, String title, String content, LoungePostCategory category, LoungePostStatus status) {
        this(id, authorUserId, title, null, content, category, status);
    }

    public LoungePost(Long id, UserId authorUserId, String title, String postImageUrl, String content, LoungePostCategory category, LoungePostStatus status) {
        this.id = id;
