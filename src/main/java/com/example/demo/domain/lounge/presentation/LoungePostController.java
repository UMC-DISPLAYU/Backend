...
public class LoungePostController {
    ...
    public ApiResponseBody<LoungePostDetailResponse> createPost(
        ...
        Long loungePostId = loungePostCommandService.createPost(TEMP_USER_ID, loungePostRequest.toCommand());
    ...
    public ApiResponseBody<LoungePostLikeResponse> likePost(
            ...
            HttpServletRequest request) {
        return ApiResponseBody.success(
                mapper.toResponse(loungePostCommandService.likePost(loungePostId, TEMP_USER_ID)),
                request);
    }
    ...
    public ApiResponseBody<LoungePostScrapResponse> scrapPost(
            ...
            HttpServletRequest request) {
        return ApiResponseBody.success(
                mapper.toResponse(loungePostCommandService.scrapPost(loungePostId, TEMP_USER_ID)),
                request);
    }
