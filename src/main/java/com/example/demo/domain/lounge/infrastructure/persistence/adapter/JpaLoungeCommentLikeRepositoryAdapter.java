...
public class JpaLoungeCommentLikeRepositoryAdapter implements LoungeCommentLikeRepository {
    ...
    public JpaLoungeCommentLikeRepositoryAdapter(SpringDataLoungeCommentLikeJpaRepository jpaRepository) {
        this.jpaRepository = jpaRepository;
    }

    @Override
    public Optional<LoungeCommentLike> findByLoungeCommentIdAndUserId(Long loungeCommentId, UserId userId) {
