...
public enum DisplayErrorCode implements BaseErrorCode {
  ...
  DISPLAY_ALREADY_HIDDEN(HttpStatus.CONFLICT, "DISPLAY_ALREADY_HIDDEN", "이미 비공개 상태인 전시입니다."),
  DISPLAY_ALREADY_PUBLISHED(HttpStatus.CONFLICT, "DISPLAY_ALREADY_PUBLISHED", "이미 공개 상태인 전시입니다."),
  DISPLAY_REVIEW_ALREADY_PENDING(
