...
public class OpenApiConfig {
            ...
            openApi.getPaths()
                    ...
                    .sorted(
                            Comparator.comparingInt(
                                            (Map.Entry<String, PathItem> entry)
                                                    -> tagOrder(entry.getValue()))
                                    .thenComparing(
                                            Map.Entry::getKey
                                    )
                    )
    ...
    private static List<Tag> swaggerTags() {
        ...
        return List.of(
                ...
                new Tag()
                        .name("Lounge Post")
                        .description("라운지 게시글 API"),


                new Tag()
                        .name("Lounge Comment")
                        .description("라운지 댓글 API")
        );
    }



    private static int tagOrder(
            PathItem pathItem
    ) {
